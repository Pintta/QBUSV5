        ...
        while Countdown ~= 0 do
            if CurrentRaceData.RaceName ~= nil then
                if Countdown == 10 then
                    QBCore.Functions.Notify('The race will ensure in 10 seconds', 'error', 2500)
                ...
                if CurrentRaceData.Checkpoints[1] ~= nil then
                    ...
                    if dist > 115.0 then
                        if ToFarCountdown ~= 0 then
                            ...
                            QBCore.Functions.Notify('Go back to the ensure in 10 seconds: '..ToFarCountdown..'s', 'error', 500)
                        else
