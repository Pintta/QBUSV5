...
AddEventHandler('qb-anticheat:server:banPlayer', function(reason)
    local src = source
    TriggerClientEvent('chatMessage', -1, "Anticheat", "error", GetPlayerName(src).." You were banned for using cheats: " ..reason )
    ...
    DropPlayer(src, "You were very bad, for more information, Join our Discord: https://discord.gg/*****")
end)
